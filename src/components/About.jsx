...
const ServiceCard = ({ index, title, icon }) => (
  ...
  <motion.div
    ...
    className='w-[160px] h-[160px] p-4 rounded-[24px] glassmorphism flex flex-col items-center justify-center gap-3 transition-all duration-300'
  >
    <div className='w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center relative transition-colors duration-300'>
      <div className='absolute inset-0 rounded-xl blur-lg opacity-10 bg-[#915eff]' />
